...
#Format - Strings
"String Format"
recap ='As we learned in the Python Variables chapter, we cannot combine strings and numbers like this:'
...
'''To include a placeholder in the string, use curly brackets {}.

If you want to include a curly bracket in the string, you can escape it by doubling it:'''
...
#Example
Note = 'You will get an error if you use double quotes inside a string that is surrounded by double quotes:'
...
#\f	Form Feed	
#This example moves to the next page (form feed):
txt = "Hello\fWorld!"
print(txt)
